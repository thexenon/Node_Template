...
exports.signup = catchAsync(async (req, res, next) => {
  ...
  // TODO: Create url to let user verify using website
...
exports.verifyme = catchAsync(async (req, res, next) => {
  ...
  // TODO: Change to verified success email template
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  // TODO: Create web form for forget password and edit url to match webpage
  try {
...
exports.logout = (req, res) => {
  ...
  res.status(200).json({ statusType: 'success' });
};
